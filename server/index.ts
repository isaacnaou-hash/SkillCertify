...
// FIX: The redundant import of the payment service has been REMOVED.
// The payment logic (checkPaymentConfiguration, etc.) is now handled inside 
// the 'registerRoutes' function that is imported above.
